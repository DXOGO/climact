    ...
    <div className={styles.container}>
      ...
      <div className={styles.rightColumn}>
        ...
        <p className={styles.text}>
          ...
          <br /><br />
          <span>T1 – Acquisition and pre-processing of CMIP6 climatic data for three CMIP6 future climate scenarios: SSP5-8.5, a business-as-usual scenario; SSP1-2.6, a sustainable scenario that meets the Paris Agreement targets; and SSP2-4.5, a middle-of-the-road scenario.</span>
          <br /><br />
          <span>T2 – Carry out a high-resolution (5 km) dynamical downscaling of CMIP6 global climate projections for Portugal.</span>
          <br /><br />
          <span>T3 – Perform a detailed characterization of Portugal's future climate scenarios.</span>
          <br /><br />
          <span>T4 – Production of a Future Climate Atlas for Portugal that makes available ClimACT results, tailored and targeted to be used by the scientific community, decision-makers and stakeholders connected to the sectors most vulnerable to climate change impacts in Portugal such as extreme weather, forest fires, water resources, air quality, human health, renewable energies and agriculture. Integrated analysis and dissemination of all the obtained results.</span>
          <br /><br />
